...
layout: page
page-type: ori-model
thumbnail: basketweave.jpg
title: 3-Way Basketweave
comments-id: "ori-3-way-basketweave"
date: 2025-08-31 00:00:00 -0400
description: "A basketweave with 3 strips in parallel"
---
<div class="figrow">
    <figure>
        <img style="max-width: 400px;" src="basketweave.jpg">
    </figure>
    <figure>
        {% fold %} <img style="max-width: 400px;" src="basketweave.fold"> {% endfold %}
    </figure>
</div>
...
the rectangles must be separated, and it'd be nice if they were separated by a nice amount. Hence the crease pattern above.
...
<div class="figrow">
    <figure>
        {% fold %} <img style="max-width: 800px;" src="open-basketweave.fold"> {% endfold %}
