...
class WboitUtils {
	...
	static patch( existingMaterial: THREE.Material ) {
		...
		for ( let i = 0; i < materials.length; i ++ ) {
			...
			material.onBeforeCompile = function( shader: THREE.WebGLProgramParametersWithUniforms, renderer: THREE.WebGLRenderer ) {
